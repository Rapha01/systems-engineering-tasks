...
void implementCAS(uint64_t* context) {
  ...
  if (debug_CAS) {
    ...
    print((uint64_t*) getName(context)); println();
    print((uint64_t*) "old : ");printInteger(old); println();
    print((uint64_t*) "new : ");printInteger(new); println();
    print((uint64_t*) "addressvalue : ");printInteger(addressvalue); println();
    print((uint64_t*) "address : ");printInteger(vaddr); println();
  }
